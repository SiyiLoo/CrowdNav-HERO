...
class MPRLTrainer(object):
    def __init__(self, value_estimator, state_predictor, map_predictor, memory, ped_memory, ped_memory_batch, device, policy, writer, batch_size, optimizer_str, human_num,
